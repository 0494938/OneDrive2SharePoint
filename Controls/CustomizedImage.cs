...
namespace GcjUiCtrl.Control
{
    ...
    public partial class CustomizedImage : System.Windows.Controls.Image
    {
        ...
        public CustomizedImage() : base()
        {
            Loaded += CustomizedImage_Loaded;
            SizeChanged += CustomizedImage_SizeChanged;
            Drop += CustomizedImage_Drop;
            DragEnter += CustomizedImage_DragEnter;
            DragOver += CustomizedImage_DragOver;
        }

        private void CustomizedImage_SizeChanged(object sender, SizeChangedEventArgs e)
        {
        }

        private void CustomizedImage_LayoutUpdated(object? sender, EventArgs e)
        {
        }

        private void CustomizedImage_Loaded(object sender, RoutedEventArgs e)
        {
        }
        ...
        [Description("Gets or sets the CustomizedImage Drop File Path")]
        [Category("GcjControl")]
        ...
        private void CustomizedImage_DragOver(object sender, DragEventArgs e)
        {
        ...
        private void CustomizedImage_Drop(object sender, DragEventArgs e)
        {
            if (AllowDrop == true && e.Data.GetDataPresent(DataFormats.FileDrop))
            {
