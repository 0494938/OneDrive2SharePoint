...
namespace IsidTestApp
{
    ...
    /// </summary>
    public partial class IsidTestShadowWindow : GcjBaseWindow
    {
        ...
        public IsidTestShadowWindow()
        {
            InitializeComponent();
            Loaded += IsidTestControlWindowShadow_Loaded;
            Unloaded += IsidTestControlWindowShadow_Unloaded;
            // 初始化TextBox内容
            for (int j = 0; j < 100; j++)
            {
        ...
        private void IsidTestControlWindowShadow_Unloaded(object sender, RoutedEventArgs e)
        {
        }

        private void IsidTestControlWindowShadow_Loaded(object sender, RoutedEventArgs e)
        {
        }
